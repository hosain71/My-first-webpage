...
const Banar = () => {
    return (
        <div className='container mx-auto '>
            <div className='flex justify-between bg-[#b5f79e] md:flex-row flex-col '>
              <div className=''>
                    <div>
                        <h1 className='text-4xl m-5'>Hello</h1>
                    </div>
                    <h1 className='text-3xl m-5'>I'm Hosain Ahmad</h1>
            ...
            <div>
                <img className=' md:w-100 h-100 justify-between m-5 ' src={Hosain} alt="" />
            </div> 
